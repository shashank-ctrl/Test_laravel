...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{asset ('admintheme/bower_components/morris.js/morris.css') }}">
  <!-- jvectormap -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{asset ('admintheme/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}">
